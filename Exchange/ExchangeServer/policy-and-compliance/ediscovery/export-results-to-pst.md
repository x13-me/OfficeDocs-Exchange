...
- You can't use the PST export tool with accounts that require mult-factor authentication (MFA). Instead, you need to create an app password for the PST export tool. For instructions, see [Create an app password for Microsoft 365](https://support.office.com/article/3e7c860f-bda4-4441-a618-b53953ee1183).
