...
This example delivers email to the mailbox of Douglas Kohn and, at the same time, forwards all mail sent to Douglas Kohn to a external email addresses, douglaskohn.parents@fineartschool.net.
