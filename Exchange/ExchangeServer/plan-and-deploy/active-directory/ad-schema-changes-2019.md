---
title: "Active Directory schema changes in Exchange 2019"
ms.author: dstrome
author: dstrome
manager: serdars
ms.date: 4/19/2018
...
description: "Summary: Learn about the new and modified schema classes and attributes that are added to Active Directory by Exchange 2019."
---
...
> [!NOTE]
> The Active Directory schema changes that are described in this topic might not apply to all editions of an Exchange Server version. To verify that Active Directory has been successfully prepared, see the [How do you know this worked?](../prepare-ad-and-domains.md#how-do-you-know-this-worked) section in [Prepare Active Directory and domains for Exchange 2019](../prepare-ad-and-domains.md).
