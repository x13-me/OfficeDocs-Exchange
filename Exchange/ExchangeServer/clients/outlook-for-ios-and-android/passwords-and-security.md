...
Before you enable anything that allows for the transmission of passwords from your on-premises Exchange environment, be sure to consider the ramifications of such implementations. For example, transmitting password to Outlook services might result in your inability to meet the requirements of PCI-DSS or ISO/IEC 27001.
