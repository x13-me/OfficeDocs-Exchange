...
|WMSVC|This Windows self-signed certificate is used by the Web Management service in IIS to enable remote management of the web server and its associated web sites and applications. <br/> If you remove this certificate, the Web Management service will fail to start if no valid certificate is selected. Having the service in this state can prevent you from installing Exchange updates, or uninstalling Exchange from the server. For instructions on how to correct this issue, see [Event ID 1007 - IIS Web Management Service Authentication](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc735088(v=ws.10))|
...
|Hybrid deployment with Microsoft 365 or Office 365|For more information, see [Certificate Requirements for Hybrid Deployments](https://docs.microsoft.com/exchange/certificate-requirements).|
...
For more information, see [Get-ExchangeCertificate](https://docs.microsoft.com/powershell/module/exchange/get-exchangecertificate).
