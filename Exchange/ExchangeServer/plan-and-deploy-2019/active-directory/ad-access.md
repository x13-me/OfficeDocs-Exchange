---
title: "Access to Active Directory in Exchange 2019"
ms.author: chrisda
author: chrisda
manager: serdars
ms.date: 7/19/2018
...
ms.assetid: 
description: "Summary: How Exchange 2019 retrieves data from Active Directory, and how to recover deleted objects."
---

# Access to Active Directory in Exchange 2019

 **Summary**: How Exchange 2019 retrieves data from Active Directory, and how to recover deleted objects.
  
Exchange Server 2019 stores all configuration and recipient information in the Active Directory directory service database. When an Exchange 2019 server requires information about recipients the configuration of the Exchange organization, it queries Active Directory. Active Directory servers must be available for Exchange 2019 to function correctly.
  
This topic explains how Exchange 2019 stores and retrieves information in Active Directory so that you can plan access to Active Directory. This topic also discusses issues you should be aware of if you try to recover deleted Exchange 2019 Active Directory objects.
...
For more information about schema modifications in Exchange 2019, see [Exchange 2019 Active Directory schema changes](ad-schema-changes.md).
