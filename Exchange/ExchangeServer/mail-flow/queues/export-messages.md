...
description: "Summary: Learn how to export messages from queues in Exchange Server."
---

# Export messages from queues

 **Summary**: Learn how to export messages from queues in Exchange 2016 and Exchange 2019.
