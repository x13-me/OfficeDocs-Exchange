...
|n/a|`Priority`|Equals (`-eq`) <br/><br/> Does not equal (`-ne`)|The priority (importance) of the message that's assigned by the user in Microsoft Outlook or Outlook on the web. Valid values are `Low`, `Normal`, and `High`. For more information, see [Priority Queuing](../../../ExchangeServer2013/priority-queuing-exchange-2013-help.md).|
