...
To get the latest version of Exchange 2016, download and install [Cumulative Update 20 for Exchange Server 2016](https://www.microsoft.com/download/details.aspx?familyID=2104c33b-430e-4b3e-95ec-ca42585053ba). Because each CU is a full installation of Exchange that includes updates and changes from all previous CUs, you don't need to install any previous CUs or Exchange 2016 RTM first.
