                ...
                <ul id="home">
                    <li>
                        ...
                        <ul id="home-all" class="cardsC">
                            ...
                            <li>
                                <a href="https://go.microsoft.com/fwlink/p/?linkid=825">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="https://go.microsoft.com/fwlink/p/?linkid=627326">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Learn about the PowerShell cmdlets you need to manage Exchange Server or Exchange Online.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
