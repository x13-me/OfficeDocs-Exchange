...
- In the EAC, go to **Recipients** \> **Mailboxes**. In the properties of the mailbox window that opens, click **Mailbox features**. In the **Email connectivity** section under **Outlook on the web: Enabled**, click **View details**, and verify the name of the policy in the **Outlook Web App** mailbox policy window that appears.
