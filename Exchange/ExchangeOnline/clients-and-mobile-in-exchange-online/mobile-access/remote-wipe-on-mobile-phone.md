...
> 
> This setting is not available on the modern EAC. If the classic EAC was deprecated, you must use [Exchange Online PowerShell](#use-outlook-on-the-web-to-wipe-a-users-phone).
