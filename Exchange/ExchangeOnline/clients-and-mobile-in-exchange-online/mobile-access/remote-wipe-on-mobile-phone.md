...
> 
> This setting is not available on the modern EAC. If the classic EAC was deprecated, you must use [Exchange Online PowerShell](#-Use-Exchange-Online-PowerShell-to-wipe-a-user's-phone).
