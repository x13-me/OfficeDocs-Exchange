...
|com.microsoft.outlook.Mail.SMIMEEnabled.LDAPHostName |This key specifies the LDAP directory endpoint to query for certificates.<br/><br/> **Value type**: String <br/><br/> **Accepted values**: ldaps://domainname:protocol, domainname:protocol <br/><br/> **Default if not specified**: N/A <br/><br/> **Required**: No <br/><br/> **Example**: ldaps://contoso.com<br>contoso.com<br>ldaps://contoso.com:636<br>contoso.com:636 |Managed Devices, Managed Apps|
