...
|**Custom reports using Microsoft Graph**|Programmatically create the reports that are available in the Office 365 admin center by using Microsoft Graph|n/a|The subtopics of [Working with Office 365 usage reports in Microsoft Graph](https://go.microsoft.com/fwlink/p/?linkid=865135)|
