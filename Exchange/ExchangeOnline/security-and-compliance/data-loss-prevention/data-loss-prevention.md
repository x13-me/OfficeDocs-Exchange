...
> [!NOTE]
> Legacy Exchange Online data loss prevention in the Exchange admin center is in the process of being deprecated. We recommend that you create DLP policies in the Microsoft Purview portal. For more information about this DLP, see [Learn about data loss prevention](/microsoft-365/compliance/dlp-learn-about-dlp).
>
...
>
> You can easily migrate your legacy Exchange Online DLP policies using the migration wizard. For more information, see [Migrate Exchange Online data loss prevention policies to the Microsoft Purview portal](/microsoft-365/compliance/dlp-migrate-exo-policy-to-unified-dlp).
>
