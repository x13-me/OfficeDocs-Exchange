...
- Users can apply signatures to their own outgoing messages in Outlook or Outlook on the web (formerly known as Outlook Web App). For more information, see [Create and add an email signature in Outlook on the web](https://support.mcrosoft.com/office/0F230564-11B9-4239-83DE-F10CBE4DFDFC).
