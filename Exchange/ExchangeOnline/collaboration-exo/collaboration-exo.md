...
> [!NOTE]
> <sup>1</sup> Depending on worklod, it may be very small. If more than a few users will need to access a Shared mailbox at the same time, consider one of the other options.
