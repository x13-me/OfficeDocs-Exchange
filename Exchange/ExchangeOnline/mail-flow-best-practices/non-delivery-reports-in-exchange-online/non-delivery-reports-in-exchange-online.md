...
|4.7.322|Certificate-expired: The destination email server's certificate is expired.|DNSSEC checks have passed. Besides the connection, destination mail server provides expired certificate.|Present a valid X.509 certificate that isn't expired. X.509 certificates must be renewed (annually) after their expiration.|
