...
|4.7.324|DNSSEC-invalid: The destination domain has returned invalid DNSSEC records.|The destination domain indicated authenticity of DNSSEC, but the Exchange Online was not able to verify authenticity of DNSSEC.|For more information, see [Overview of DNSSEC.](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/jj200221(v=ws.11))|
