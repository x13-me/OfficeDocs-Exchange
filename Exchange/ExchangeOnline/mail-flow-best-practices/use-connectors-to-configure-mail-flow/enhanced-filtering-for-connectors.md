...
5. If you have an ETR rule that force messages to skip filtering once it comes into EOP (i.e. marking the SCL of the message to -1 to prevent double filtering), you will need to disable that transport rule.
