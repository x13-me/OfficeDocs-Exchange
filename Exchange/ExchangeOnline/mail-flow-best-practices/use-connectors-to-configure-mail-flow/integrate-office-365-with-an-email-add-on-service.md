...
7. On the **Validation email** page, do these steps:
   ...
   3. After the validation process is complete, click **Next**.
...
#### Mail flow rule creation in the new EAC

> [!NOTE]
> The mail flow rule creation in the new EAC is exactly the same as in the classic EAC.

#### Mail flow rule creation in the classic EAC
...
5. On the **Authenticating sent email** page, verify that the first option is selected (verify by certificate), and enter the certificate domain that the email add-on service gave to you when you enrolled in the service (for example, S5HG3DCG14H8S1R2303RZHM4RX.smtp.contososignatureservice.com).
