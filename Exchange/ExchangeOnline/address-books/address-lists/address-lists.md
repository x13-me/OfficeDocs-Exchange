...
For detailed instructions about creating address lists in Exchange Server, see see [Address list procedures in Exchange Online](address-list-procedures.md).
