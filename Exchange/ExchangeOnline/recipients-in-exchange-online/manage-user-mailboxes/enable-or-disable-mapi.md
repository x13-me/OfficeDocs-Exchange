...
2. Select the mailbox for which you want to enable or disable MAPI, and click the display name.
...
4. Disable the **Outlook desktop (MAPI)** option which is enabled by default.
