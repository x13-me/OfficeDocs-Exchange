...
For detailed syntax and parameter information, see [Get-RecoverableItems](https://docs.microsoft.com/en-us/powershell/module/exchange/get-recoverableitems?).
...
For detailed syntax and parameter information, see [Restore-RecoverableItems](https://docs.microsoft.com/en-us/powershell/module/exchange/restore-recoverableitems?).
...
Are you using Exchange Server? See [Recover deleted messages in a user's mailbox in Exchange Server](https://docs.microsoft.com/en-us/exchange/recipients/user-mailboxes/recover-deleted-messages?).
