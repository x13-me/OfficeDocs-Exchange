...
### [Opt-inExchange Online enpoint for legacy TLS using SMTP AUTH](../clients-and-mobile-in-exchange-online/opt-in-exchange-online-endpoint-for-legacy-TLS-using-SMTP-AUTH.md)
