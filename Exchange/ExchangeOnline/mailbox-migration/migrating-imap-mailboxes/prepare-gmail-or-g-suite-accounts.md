...
You will also have to do this if your admin is planning to migrate your [Gmail](https://support.office.com/article/20fdb8f2-fed8-4b14-baf0-bf04b9c44bf7.aspx) or [G Suite Gmail](migrate-g-suite-mailboxes.md) to Microsoft 365 or Office 365.
...
7. Now you're ready to add your Gmail account to Outlook. When you're prompted for a password, you *enter this app password for your Gmail account*. Don't enter your Gmail password. For instructions on adding your Gmail account to Outlook, see these articles:
   ...
   - [Connect email accounts in Outlook on the web (Microsoft 365)](https://support.office.com/article/d7012ff0-924f-4f78-8aca-c3912d886c4d)
