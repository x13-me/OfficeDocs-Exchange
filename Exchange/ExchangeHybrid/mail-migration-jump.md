...
## What do I need to run the mail advisor?

To run the Office 365 mail advisor, you'll need the following:
...
## What options will I have when I run the mail advisor?
