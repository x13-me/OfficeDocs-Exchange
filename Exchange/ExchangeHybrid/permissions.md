...
|Exchange 2010|Not supported anymore.<br> Previously, On-premises remote mailboxes associated with Microsoft 365 or Office 365 mailboxes needed to be configured to support ACLs. This was required to be done for each on-premises remote mailbox that's associate with an Microsoft 365 or Office 365 mailbox.|
