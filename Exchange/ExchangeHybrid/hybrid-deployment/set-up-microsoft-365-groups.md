...
> [!IMPORTANT]
After the steps of this article are successfully performed, the On-Premises mailbox can send and receive emails to Microsoft 365 Group. However, the Microsoft 365 Group will not appear in the navigation bar of Outlook on the web or Outlook desktop client. For full fledged Microsoft 365 Group exprience, the mailbox must be present in Microsoft 365. 
