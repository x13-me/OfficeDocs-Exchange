...
2. Open the Exchange Management Shell on a server running the latest available Exchange 2013 CU Or 2016 , or the immediately previous CU.
...
1. Open the Exchange Management Shell on a server running the latest available Exchange 2013 CU Or Exchange 2016 , or the immediately previous CU.
