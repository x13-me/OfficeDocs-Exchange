...
- **Older Versions of Azure AD connect won't install DSACLS.exe**. So it will be required to install RSAT or lastest Version of Azure AD Connect to manage permissions on groups if required.
