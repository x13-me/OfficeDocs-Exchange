...
> [!NOTE]
  > If you already started a migration process with Exchange 2010 Hybrid endpoints and do not plan to keep on-premises mailboxes, continue your migration as-is. If you plan to keep some mailboxes on-premises, we strongly recommend you to introduce Exchange 2016 Hybrid endpoints (as Exchange 2010 has reached its end of support lifecycle). Continue your migration of Exchange 2010 mailboxes to Office 365 and then move the mailboxes that will stay on-premises to Ex2016 servers. Once you will have removed all your Exchange 2010 servers, you can then introduce Exchange 2019 servers as new Hybrid endpoints and move your remaining on-premises mailboxes to Exchange 2019 servers.
