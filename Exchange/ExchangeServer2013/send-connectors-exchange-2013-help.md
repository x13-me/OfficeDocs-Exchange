...
The default maximum message size, specified by the *MaxMessageSize* parameter, has been increased from 10MB to 25MB. [Set-SendConnector](https://docs.microsoft.com/powershell/module/exchange/mail-flow/Set-SendConnector) provides more information on how to set parameters on a Send connector.
