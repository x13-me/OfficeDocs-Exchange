...
For detailed syntax and parameter information, see the *AgentLog* parameters in [Set-TransportService](https://docs.microsoft.com/powershell/module/exchange/mail-flow/Set-TransportService).
