...
For detailed syntax and parameter information, see [Update-MailboxDatabaseCopy](https://docs.microsoft.com/powershell/module/exchange/database-availability-groups/Update-MailboxDatabaseCopy).
