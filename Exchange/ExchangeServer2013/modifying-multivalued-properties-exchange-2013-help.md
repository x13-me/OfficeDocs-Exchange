...
For more information about objects, see [Structured data](https://technet.microsoft.com/library/aa996386\(v=exchg.150\)). For more information about the Shell, see [Using PowerShell with Exchange 2013 (Exchange Management Shell)](https://docs.microsoft.com/powershell/exchange/exchange-server/exchange-management-shell).
