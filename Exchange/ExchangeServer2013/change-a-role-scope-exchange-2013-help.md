...
For detailed syntax and parameter information, see [Set-ManagementScope](https://docs.microsoft.com/powershell/module/exchange/role-based-access-control/Set-ManagementScope).
