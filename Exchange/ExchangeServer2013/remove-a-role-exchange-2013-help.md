...
For detailed syntax and parameter information, see [Remove-ManagementRole](https://docs.microsoft.com/powershell/module/exchange/role-based-access-control/Remove-ManagementRole).
