...
For more information about syntax and parameters, see [Set-PopSettings](https://docs.microsoft.com/powershell/module/exchange/client-access/Set-PopSettings).
...
For more information about syntax and parameters, see [Set-ImapSettings](https://docs.microsoft.com/powershell/module/exchange/client-access/Set-ImapSettings).
