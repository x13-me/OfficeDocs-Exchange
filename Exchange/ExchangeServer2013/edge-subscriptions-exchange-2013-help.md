...
For detailed syntax and parameter information, see [New-EdgeSubscription](https://docs.microsoft.com/powershell/module/exchange/mail-flow/New-EdgeSubscription).
