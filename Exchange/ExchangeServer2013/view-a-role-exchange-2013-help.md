...
For detailed syntax and parameter information, see [Get-ManagementRole](https://docs.microsoft.com/powershell/module/exchange/role-based-access-control/Get-ManagementRole).
