...
To view the default Receive connectors and their parameter values, you can use the [Get-ReceiveConnector](https://docs.microsoft.com/powershell/module/exchange/mail-flow/Get-ReceiveConnector) cmdlet.
...
See [New-ReceiveConnector](https://docs.microsoft.com/powershell/module/exchange/mail-flow/New-ReceiveConnector) for more information about these parameters and other parameters for Receive connectors.
