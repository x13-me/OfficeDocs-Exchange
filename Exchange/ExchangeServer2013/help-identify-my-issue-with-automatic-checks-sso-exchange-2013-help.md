...
If you already have an user account, select **Sign In**. You don't need an Azure ID account. You might be asked for a user account again when the checks run. If so, your user account is in the format *user name*\@*your Microsoft 365 or Office 365 login.domain* and your password.
