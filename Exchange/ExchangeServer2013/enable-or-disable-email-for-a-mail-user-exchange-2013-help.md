...
For detailed syntax and parameter information, see [Disable-MailUser](https://docs.microsoft.com/powershell/module/exchange/users-and-groups/Disable-MailUser).
