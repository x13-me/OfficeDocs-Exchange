...
The following table lists the default search filters installed on an Exchange 2013 Mailbox server and in Exchange Online. You can retrieve the list of default filters by using the [Get-SearchDocumentFormat](https://docs.microsoft.com/powershell/module/exchange/mailbox-databases-and-servers/Get-SearchDocumentFormat) cmdlet.
