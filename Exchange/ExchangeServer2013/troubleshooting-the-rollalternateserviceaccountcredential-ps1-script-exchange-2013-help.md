...
> [!WARNING]
> Before you remove the RPC Client Access service from a server, see the topic <A href="https://docs.microsoft.com/powershell/module/exchange/client-access-servers/Remove-RpcClientAccess">Remove-RpcClientAccess</A>.
