...
For detailed syntax and parameter information, see [Set-TransportService](https://docs.microsoft.com/powershell/module/exchange/mail-flow/Set-TransportService).
...
To verify that you have successfully enabled or disbled IRM logging on a server, run the [Get-TransportService](https://docs.microsoft.com/powershell/module/exchange/mail-flow/Get-TransportService) cmdlet to retrieve IRM settings.
