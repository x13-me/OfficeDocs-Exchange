...
- **Seeding using the Update-MailboxDatabaseCopy cmdlet**: You can use the [Update-MailboxDatabaseCopy](https://docs.microsoft.com/powershell/module/exchange/database-availability-groups/Update-MailboxDatabaseCopy) cmdlet in the Shell to seed a database copy at any time.
...
6. Add the mailbox database copy by using the [Add-MailboxDatabaseCopy](https://docs.microsoft.com/powershell/module/exchange/database-availability-groups/Add-MailboxDatabaseCopy) cmdlet with the *SeedingPostponed* parameter, as shown in this example.
