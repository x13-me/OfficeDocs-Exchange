...
For detailed syntax and parameter information, see [Set-ImapSettings](https://docs.microsoft.com/powershell/module/exchange/client-access/Set-ImapSettings) and [Set-PopSettings](https://docs.microsoft.com/powershell/module/exchange/client-access/Set-PopSettings).
